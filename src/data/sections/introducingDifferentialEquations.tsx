    ...
    <StackLayout key="layout-orientation-promise" maxWidth="xl">
        <Block id="orientation-promise" padding="sm">
            <EditableParagraph id="para-orientation-promise" blockId="orientation-promise">
                The equation that describes this is called a differential equation: instead of giving
                you the temperature, it gives you how fast the temperature is changing. By the end you
                will write one for that mug and use it to predict how warm the drink is later. If you
                can differentiate x² and e to the x, you have the only tool you need.
            </EditableParagraph>
        </Block>
    </StackLayout>,
];
